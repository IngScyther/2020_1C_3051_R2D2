...
{
    class CamaraTPEstatica : TgcCamera
    {
        ...
        /// </summary>
        public CamaraTPEstatica()
        {
            resetValues();
        }

        public CamaraTPEstatica(TGCVector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public CamaraTPEstatica(TGCVector3 target, TGCVector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
